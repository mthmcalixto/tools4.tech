...
export default function Home() {
	...
	useEffect(() => {
		...
		const fetchRepoStats = async () => {
			try {
				const response = await fetch('https://api.github.com/repos/mateusarcedev/tools4.tech')
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					<section className="space-y-4 p-6 bg-[#222] rounded-lg">
						...
						<p className="text-md leading-relaxed">
							Tools4.tech aims to be a centralized hub of resources, benefiting both novice and
							experienced programmers. By consolidating a wide range of tools and study materials
							in one place, the project seeks to simplify the learning and development process,
							making it more accessible and efficient for all programming experience levels.
						</p>
					</section>
					...
					<section className="space-y-4 p-6 bg-[#222] rounded-lg">
						...
						<p className="text-md leading-relaxed">
							The developer community is invited to contribute to this project, whether by adding
							new tools, updating existing information, or suggesting improvements. Together, we
							can create an even more valuable resource for the software development community.
						</p>
					</section>
				</div>
