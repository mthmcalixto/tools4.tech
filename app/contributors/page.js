...
export default function Contributors() {
  ...
  useEffect(() => {
    const fetchContributors = async () => {
      try {
        setIsLoading(true)
        const contributorsResponse = await fetch('https://api.github.com/repos/mateusarcedev/tools4.tech/contributors')
        ...
        <section className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Thank you to all the amazing contributors who have helped make this project possible.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full max-w-2xl mx-auto mb-8">
            <input
              ...
              className="flex-1 p-2 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-gray-600"
            />
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value)}
              className="p-2 rounded-lg bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-gray-600"
            >
              ...
              {isLoading ? (
                Array.from({ length: 10 }).map((_, i) => (
                  ...
                  >
                    ...
                    <div className="mt-2 w-20 h-4 bg-gray-700 rounded" />
                  </motion.div>
                ))
                ...
                filteredAndSortedContributors.map((contributor, index) => (
                  ...
                  >
                    ...
                    />
                    <span className="mt-3 text-sm font-medium text-white">{contributor.login}</span>
                ...
                <div className="col-span-full text-center py-8">
                  <p className="text-gray-400">No contributors found matching your search.</p>
                </div>
              )}
            </AnimatePresence>
          </div>
